                ...
                <div className="login-form w-full max-w-xs text-left" >
                    ...
                    <h3 className='text-blue-700 font-bold mb-2 text-center tracking-wider uppercase'>Login</h3>
                        ...
                        <div className="flex justify-center">
                            <button className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button"  onClick={props.onFormSubmit(email,password)}>
                                Login
                            </button>
                        </div>
                    </form>
